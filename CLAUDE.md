...
- Subagents in `.claude/agents/` map one-to-one to the areas in AGENTS.md's repository map: `crm-dev`, `chatwoot-dev`, `automation-integration`, `devops`. Delegate area-scoped work to the matching one.
