...
| [frappe/bench](https://github.com/frappe/bench) image | CRM stack | `5.31.0` (pinned by digest) | GPL-3.0 |
| [MariaDB](https://mariadb.org/) | CRM database | `10.8.8` | GPL-2.0 |
| [Redis](https://redis.io/) | Chatwoot and CRM queues/cache | `8.10.2` (pinned by digest) | AGPL-3.0 (Redis 8 tri-license option) |
| [PostgreSQL](https://www.postgresql.org/) + [pgvector](https://github.com/pgvector/pgvector) | Chatwoot database | `pg16` (16.15, pgvector 0.8.6, pinned by digest) | PostgreSQL License |
